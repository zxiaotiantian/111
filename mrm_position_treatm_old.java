...
<title>MRM_POSITION_TREATM_OLD</title>
<style type="text/css">
...
<table class="outerTable">
  <tr class="normalBoldLarge">
     <td><h2>Code listing for function MRM_POSITION_TREATM_OLD</h2>
  ...
  <tr>
     ...
     <table class="innerTable">
       <tr>
          <td>
   <div class="code">
FUNCTION mrm_position_treatm_old.<br />
   </div>
...
<div class="codeComment">*       <a href ="global-mrm_position_treatm_old.html">Global data declarations</a></div><br />
   </div>
   <div class="code">
